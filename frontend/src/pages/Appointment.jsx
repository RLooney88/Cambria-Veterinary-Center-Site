...
export default function Appointment() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      toast.error("Something went wrong. Please call us at (410) 399-0344.");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="max-w-3xl mx-auto py-24 text-center" data-testid="appointment-booked">
          ...
          <p className="mt-2 text-clinic-mist text-sm">
            ...
            <a href="tel:+14103990344" className="font-bold text-clinic-navy underline">(410) 399-0344</a>.
          </p>
        </div>
        <div className="pb-24">
          <Testimonials />
    ...
    <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-12 pb-24" data-testid="appointment-page">
      <div className="grid gap-10 lg:grid-cols-12">
        <div className="lg:col-span-5">
          ...
          >
            <Phone className="h-4 w-4" /> (410) 399-0344
          </a>
        </div>
