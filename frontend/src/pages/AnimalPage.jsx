...
const ANIMALS = {
  dogs: {
    ...
    quote: {
      ...
      author: "the Cambria Veterinary Center team, DVM",
    },
    life_stages: [
      { name: "Puppy", age: "6 wks â€“ 1 yr", focus: "Vaccine series, deworming, nutrition counseling, spay/neuter planning, training guidance.", icon: "paw", image: "/images/animals/dog-puppy.webp" },
      { name: "Adult", age: "1 â€“ 7 yrs", focus: "Annual wellness, dental care, parasite prevention, weight management, lifestyle vaccines.", icon: "shield", image: "/images/animals/dog-adult.webp", objectPosition: "center top" },
      { name: "Senior", age: "7 yrs +", focus: "Twice-yearly exams, bloodwork, joint support, quality-of-life planning.", icon: "heart", image: "/images/animals/dog-senior.webp" },
    ],
    conditions: [
    ...
    faqs: [
      { q: "How often should my adult dog come in?", a: "Once a year for healthy adults (1â€“7 yrs), twice a year for seniors. Puppies follow their own schedule for the first year." },
      ...
      { q: "What signs mean I should call you today?", a: "Not eating for 24 hours, repeated vomiting, difficulty breathing, suspected toxin ingestion, sudden lameness, seizures, or any bloated belly. Call (410) 399-0344." },
      ...
      { q: "Can you help my senior dog stay comfortable?", a: "Absolutely. joint support, weight management, multimodal pain control, and PRP/regenerative options, we combine them for real quality of life." },
    ],
    services: ["wellness-exams", "vaccinations", "dental-care", "surgery", "parasite-prevention", "radiology", "ultrasound", "microchipping", "senior-care", "emergency-care"],
  },
  cats: {
    slug: "cats",
    title: "Cats",
    ...
    life_stages: [
      { name: "Kitten", age: "8 wks â€“ 1 yr", focus: "Vaccine series, deworming, spay/neuter, nutrition, socialization, microchipping.", icon: "paw", image: "/images/animals/cat-kitten.webp" },
      { name: "Adult", age: "1 â€“ 10 yrs", focus: "Annual wellness exam, dental screening, parasite prevention, weight and behavior check-ins.", icon: "shield", image: "/images/animals/cat-adult.webp", objectPosition: "center top" },
    ...
    services: ["wellness-exams", "vaccinations", "dental-care", "senior-care", "surgery", "radiology", "microchipping", "parasite-prevention", "emergency-care"],
  },
  critters: {
    slug: "critters",
    ...
    faqs: [
      ...
      { q: "My rabbit stopped eating, is that urgent?", a: "Yes. GI stasis is life-threatening in rabbits. Call (410) 399-0344 immediately or head to an exotics ER." },
        ...
        <div className="relative z-10 h-full">
          <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-36 lg:pt-40 pb-16">
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              ...
              >
                <Phone className="h-4 w-4" /> Call (410) 399-0344
              </a>
              <Link
                to="/services"
