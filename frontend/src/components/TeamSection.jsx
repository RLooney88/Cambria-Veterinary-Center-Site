...
const FALLBACK_TEAM = [
  {
    name: "Cambria Veterinary Center Team",
    role: "Veterinary Care Team",
    bio: "No individual staff profiles were available beyond the public practice-owner listing, so this demo uses a team-focused presentation rather than invented names.",
    image: "",
  },
];
